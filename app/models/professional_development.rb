class ProfessionalDevelopment < Course
  default_scope { where(:registration_type => "pro_development") }
  before_save { self.registration_type = "pro_development" }
  
  
  RailsAdmin.config do |config|
    config.model ProfessionalDevelopment do    
